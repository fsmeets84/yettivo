  ...
  return (
    ...
    <div className="min-h-screen bg-transparent pt-32 pb-20 relative overflow-hidden">
      <div className="container mx-auto px-8 relative z-10">
        ...
        {/* Header Skeleton - Matches the WatchlistPage title and meta */}
        <header className="mb-12 space-y-4">
          <div className="h-3 w-40 bg-white/[0.05] animate-pulse rounded-full" />
          <div className="h-10 w-64 bg-white/[0.05] animate-pulse rounded-2xl" />
          <div className="h-4 w-56 bg-white/[0.03] animate-pulse rounded-full" />
        </header>

        {/* Grid Skeleton - Matches the 6-column layout of the archive */}
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
          {[...Array(12)].map((_, i) => (
            <div key={i} className="space-y-4">
              {/* Poster Skeleton using the glass-card utility from globals.css */}
              <div className="aspect-[2/3] w-full glass-card animate-pulse border-white/5" />
              
              {/* Text Meta Skeletons in the correct position */}
              <div className="px-1 space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="h-3 w-16 bg-white/[0.03] animate-pulse rounded-full" />
                </div>
              </div>
            </div>
          ))}
